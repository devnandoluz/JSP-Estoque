            ...
            <div class="card mb-3">
                ...
                <div class="card-body">
                    <div class="col-md-12">
                        ...
                        <form id="formCliente" data-toggle="validator" role="form" method="post" action="gerenciar_usuario.do">
                            <div class="row">
                                <div id="divFuncionario" class="col-md-10" ><!--Funcionnario Form-->
                                    <center><h3 class="card-header bg-dark h3" style="opacity: 0.6; color: white; border-radius: 0px 0px 20px 20px;">FUNCIONARIO</h3></center>
                                    
                                    <div class="card-body" style="opacity: 0.6">
                                        <div class="form-group">
                                            <label for="inputNome" class="control-label">NOME</label>
                                            <input id="inputNome" name="nome"  value="<%= funcionario.getNome() %>" type="text" class="form-control" placeholder="Nome do funcionário..." disabled>
                                        </div>
                                        <div class="row">
                                            <div class="form-group col-md-6">
                                                <label class="form-label">CPF</label>
                                                    <input name="cpf" type="text" value="<%= funcionario.getCpf()%>" class="form-control cpf" placeholder="000.000.000-00" data-error="Por favor, informe um CPF válido." data-minlength="14"  disabled>
                                                <div class="help-block with-errors"></div>
                                            </div>
                                            <div class="form-group col-md-6">
                                                <label class="form-label">RG</label>
                                                <input name="rg" type="text" value="<%= funcionario.getRg()%>" class="form-control rg" placeholder="0.000.000" data-error="Por favor, informe um RG válido." data-minlength="9"  disabled>
                                                <div class="help-block with-errors"></div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="form-group col-md-6">
                                                ...
                                                <input name="sexo" type="text" value="<%= funcionario.getSexo() %>" class="form-control" placeholder="SEXO do funcionário..." data-error="Este campo é necessário."  disabled>
                                                <div class="help-block with-errors"></div>
                                            </div>
                                            <div class="form-group col-md-6">
                                                ...
                                                <div class="input-group" id="datetimepicker1">
                                                    ...
                                                    %>
                                                    <input name="data_de_nascimento" type="text" value="<%= sdf.format(funcionario.getDataDeNascimento())%>" class="form-control data datepicker" data-provide="datepicker"  placeholder="00/00/0000" data-error="Este campo é necessário."  disabled>
                                                    <div class="help-block with-errors"></div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <input name="cargo" type="text" value="<%= funcionario.getCargo()%>" class="form-control" placeholder="CARGO do funcionário..." data-error="Este campo é necessário." disabled>
                                            <div class="help-block with-errors"></div>
                                        </div>
                                        <div class="form-group">
                                            <label class="form-label">ENDEREÇO</label>
                                            <input name="endereco" type="text" value="<%= funcionario.getEndereco()%>" class="form-control" placeholder="Estado, cidade, rua..." data-error="Este campo é necessário." disabled>
                                            <div class="help-block with-errors"></div>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="form-group col-md-6">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input name="telefone" type="text" value="<%= funcionario.getTelefone()%>" class="form-control telefone" placeholder="(00) 00000-0000" data-error="Este campo é necessário." disabled>
                                                </div>
                                            </div>
                                            <div class="form-group col-md-6">
                                                <label class="form-label">E-MAIL</label>
                                                 <div class="input-group">
                                                    ...
                                                    <input name="email" type="email" value="<%= funcionario.getEmail()%>" class="form-control" placeholder="exemplo@email.com" disabled>
                                                 </div>
                                            </div>
                                        </div>
                                    </div>
                                        <div class="form-inline" onload="MudarForm();" style="opacity: 0.6">
                                            <div class="toggle form-inline">
                                                ACESSO AO SISTEMA
                                                <input id="foo"  data-on="Ready" data-off="Not Ready" type="checkbox" onclick="MudarForm();" disabled>
                                                <label for="foo"></label>
                                            </div>
                                        </div>
                                </div>

                                <div class="card col-md-5" id="divUsuario" style="display: none;border-radius: 2%;"> <!--Usuario Form-->
                                    ...
                                    <div class="card-body">
                                        <input type="hidden" value="<%= funcionario.getUsuario().getId() %>" name="idUsuario">
                                          ...
                                          <input type="hidden" name="perfil" value="<%= funcionario.getUsuario().getPerfil().getId() %>">
                                    </div>
                            ...
                            <div class="form-group align-content-center">
                                <center>
                                    ...
                                    <a class="btn btn-primary col-md-3" href="home.jsp" name="cancelar" style="margin: 2px;">
