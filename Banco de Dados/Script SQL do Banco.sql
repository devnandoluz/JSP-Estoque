...
CREATE TABLE IF NOT EXISTS `db_over_system`.`PRODUTO` (
  ...
  `ESTOQUE_idESTOQUE` INT NOT NULL COMMENT '',
  ...
  INDEX `fk_PRODUTO_ESTOQUE1_idx` (`ESTOQUE_idESTOQUE` ASC)  COMMENT '',
  CONSTRAINT `fk_PRODUTO_ESTOQUE1`
    FOREIGN KEY (`ESTOQUE_idESTOQUE`)
    REFERENCES `db_over_system`.`ESTOQUE` (`idESTOQUE`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
