                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <div class="input-group" id="datetimepicker1">
                                        ...
                                        <input name="data_de_nascimento" type="text" autocomplete="off" class="form-control data datepicker" data-provide="datepicker"  placeholder="00/00/0000" data-error="Este campo é necessário." required>
                                    </div>
                                    <div class="help-block with-errors"></div>
                                </div>
                            </div>
